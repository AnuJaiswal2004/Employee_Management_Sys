...
const NewTask = ({data}) => {
    return (
        <div className="flex-shrink-0 w-[300px] md:w-[320px] p-6 bg-[#0f1424]/60 backdrop-blur-md border border-gray-800/80 rounded-2xl flex flex-col justify-between hover:border-blue-500/30 transition-all duration-300 shadow-xl group">
            ...
            <div className="mt-6">
                <button className="w-full bg-blue-600/15 hover:bg-blue-600 text-blue-300 hover:text-white border border-blue-500/30 hover:border-blue-500 font-semibold py-2 px-3 rounded-xl text-xs transition-all duration-200 cursor-pointer active:scale-[0.98]">
                    Accept Task
                </button>
            </div>
        </div>
