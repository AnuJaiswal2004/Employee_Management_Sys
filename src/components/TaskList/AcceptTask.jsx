  ...
  return (
    <div className="flex-shrink-0 w-[300px] md:w-[320px] p-6 bg-[#0f1424]/60 backdrop-blur-md border border-gray-800/80 rounded-2xl flex flex-col justify-between hover:border-amber-500/30 transition-all duration-300 shadow-xl group">
        ...
        <div className="flex items-center gap-3 mt-6">
            <button className="flex-1 bg-emerald-600/15 hover:bg-emerald-600 text-emerald-300 hover:text-white border border-emerald-500/30 hover:border-emerald-500 font-semibold py-2 px-3 rounded-xl text-xs transition-all duration-200 cursor-pointer active:scale-[0.97]">
                Complete
            </button>
            <button className="flex-1 bg-red-600/15 hover:bg-red-600 text-red-300 hover:text-white border border-red-500/30 hover:border-red-500 font-semibold py-2 px-3 rounded-xl text-xs transition-all duration-200 cursor-pointer active:scale-[0.97]">
                Fail
            </button>
        </div>
    </div>
